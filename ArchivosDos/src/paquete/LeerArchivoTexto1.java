   ...
   public ArrayList<Estadio> leerRegistros()
   {
      ...
      try // lee registros del archivo, usando el objeto Scanner
      {
         ...
         while ( entrada.hasNext() )
         {
             ...
             e.establecerNombreE(linea_partes.get(0));
             e.establecerTipoD(linea_partes.get(1));
             e.establecerCapacidad(Double.parseDouble(linea_partes.get(2)));
         ...
         //System.out.println(op.obtenerInformacion());
         System.out.printf("El promedio es: %.2f",op.promedio_capacidades());
